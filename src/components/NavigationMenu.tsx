...
export default function SagoNavigation() {
  ...
  return (
    <header className='fixed top-4 lg:top-8 left-1/2 z-50 -translate-x-1/2 flex items-center gap-3 transition-all duration-500'>
      {/* Logo Pill */}
      <div className='rounded-full shadow-xl bg-background/80 backdrop-blur-lg border border-gray-400/30 px-4 lg:px-8 py-3 flex items-center transition-all duration-500 min-w-[180px] lg:min-w-[800px]'>
